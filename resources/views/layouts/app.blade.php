                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    ...
                    <div class="nk-sidebar-brand">
                        <a href="html/index.html" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" src="{{ asset('images/logo-white.png') }}" srcset="{{ asset('images/logo-white.png') }} 2x"
                                alt="logo">
                                        ...
                                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                                            <div class="user-toggle">
                                                <div class="user-avatars sm">
                                                    <img src="{{asset('images/admin/'.Auth::user()->admin_image)}}" alt="" srcset="">

                                                </div>
                                                <div class="user-info d-none d-md-block">
                                                    <div class="user-status">{{ucwords(Auth::user()->designation)}}</div>
                                                    <div class="user-name dropdown-indicator">{{ucwords(Auth::user()->display_name) ?? "Display name"}} </div>
                                                </div>
                                            </div>
                                        </a>
